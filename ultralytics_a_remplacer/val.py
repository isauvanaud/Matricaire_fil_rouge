...
class DetectionValidator(BaseValidator):
    ...
    def get_desc(self) -> str:
        ...
        return ("%22s" + "%11s" * 7) % ("Class", "Images", "Instances", "Box(P", "R", "mAP50", "mAP50-95", "ratio)")
    ...
    def print_results(self) -> None:
        ...
        pf = "%22s" + "%11i" * 2 + "%11.3g" * (len(self.metrics.keys)-1)  # print format (-1 pour enlever ratio de l'affichage moyen)
        ...
        if self.args.verbose and len(self.metrics.stats):
                ...
                LOGGER.info(
                    ...
                    % (
                        ...
                        *self.metrics.class_result(i),
                        (self.metrics.pred_per_class/self.metrics.nt_per_class)[i]
                    )
                )
