...
class DetMetrics(SimpleClass, DataExportMixin):
    ...
    def process(self, save_dir: Path = Path("."), plot: bool = False, on_plot=None) -> dict[str, np.ndarray]:
        ...
        self.pred_per_class = np.bincount(stats["pred_cls"].astype(int), minlength=len(self.names))
        return stats
    ...
    def keys(self) -> list[str]:
        ...
        return ["metrics/precision(B)", "metrics/recall(B)", "metrics/mAP50(B)", "metrics/mAP50-95(B)", "metrics/ratio(B)"]
